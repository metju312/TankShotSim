...
/**
 * This is an zzzexample federate demonstrating how to properly use the IEEE 1516-2010 (HLA Evolved)
 ...
 * 
 * As it is intended for zzzexample purposes, this is a rather simple federate. The
 ...
 *       stop or exit if they fail. For zzzexample, if another federate has already
 *       created the federation, the call to create it again will result in an
 *       exception. The zzzexample federate expects this and will not fail.
 ...
 * into separate methods. For zzzexample, if you want to know how to send an interaction,
 ...
 * this small zzzexample, so we'll just throw all exceptions out to the main method and
 ...
 * This zzzexample federate uses an zzzexample set of FOM modules produced by Pitch (http://pitch.se).
 * The zzzexample FOM is taken from the standard HLA Restaurant Operations model. It is split
 ...
 * process, with the zzzexample federate providing the Soup-based extension when it joins.
 */
